...
export default function Navbar() {
  ...
  return (
    <>
      <nav 
        className={`fixed top-0 left-0 w-full flex justify-between items-center p-4 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white z-50 transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="hidden md:flex gap-6 items-center font-semibold text-slate-600 dark:text-slate-300 text-sm tracking-wide shrink-0 mr-4">
          <Link to="/categories" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition">Categories</Link>
          <Link to="/manga" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition">Manga</Link>
          <Link to="/characters" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition">Characters</Link>
          <Link to="/collection" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition">Vault</Link>
          ...
          {isAuth ? (
            <div className="flex items-center gap-3 ml-2 border-l border-slate-200 dark:border-slate-700 pl-4">
               ...
               <button onClick={handleLogout} className="text-xs text-slate-500 dark:text-slate-400 hover:text-red-500 dark:hover:text-red-400 transition uppercase tracking-wider font-bold">Log Out</button>
            </div>
          ) : (
